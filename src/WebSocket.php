...
class WebSocket
{
    ...
    protected $userAgent = "php-client";
...
//			sleep(1);
     ...
     */
    protected function log($message, Client $client = null)
    {
     ...
     * @return boolean
     */
    protected function checkClientExistBySocket($socket) : bool
    {
        foreach ($this->clients as $client) {
            /* @var $client Client */
            if ($client->getSocket() == $socket) {
     ...
     * @return boolean
     */
    protected function checkOrigin(array $headers) : bool
    {
    ...
    protected function sendHttpResponse(Client $client, $httpStatusCode = 400)
    {
        $httpHeader = 'HTTP/1.1 ';
    ...
    protected function processClientHandshake(Client $client, $input)
    {
        $matches = [];
    ...
    protected function onError($socket)
    {
...
//		socket_clear_error($socket);
    ...
    protected function hybi10Encode(Client $client, $payload, $type = 'text', $masked = false)
    {
        $frameHead = array();
        $frame = '';
    ...
    protected function hybi10Decode(Client $client, $data)
    {
        $payloadLength = '';
        $mask = '';
        $unmaskedPayload = '';
